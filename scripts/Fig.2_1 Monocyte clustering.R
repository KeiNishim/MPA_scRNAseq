...
pp
ggsave('Fig. S3A.png',pp,width=20,height=7.5)
write.csv(table(s.int@meta.data[["sample"]], s.int@meta.data[["seurat_clusters"]]), "monocyte_clusters.csv")
#################################################
